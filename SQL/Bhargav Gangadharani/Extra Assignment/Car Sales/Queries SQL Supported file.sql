...
SELECT c.Name FROM Customer c JOIN SalesPerson s ON c.Name=s.Name WHERE s.SalesPerson_ID IN (SELECT SalesPerson_ID FROM Sale WHERE DATEPART(yyyy, SaleDate)= 2021);
